        ...
        <Portal selector="#portal">
          ...
          >
            <div
              ...
              ref={modalRef}
            >
              <div className="bg-white text-grey-anak border-grey-200 dark:bg-grey-800 dark:text-white dark:border-grey-700 border-0 rounded-lg shadow-lg relative flex flex-col w-full items-center justify-center outline-none">
