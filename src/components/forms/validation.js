...
const FormValidation = ({ items, onSubmit, alerts }) => {
  ...
  return (
    ...
    >
              ...
              >
                ...
                <div className="relative">
                  <input
                    ref={item.ref}
                    name={item.name}
                    type={passwordShown ? 'text' : item.type}
                  ...
                  {item.type === 'password' && (
                    <i
                      className="absolute inset-y-0 m-auto h-4 mr-2 right-0 cursor-pointer"
      ...
      <input
        type="submit"
        className="w-full bg-green-anak font-bold text-white py-2 rounded-md"
      />
    </form>
  );
};
